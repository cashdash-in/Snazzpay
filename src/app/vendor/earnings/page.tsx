        ...
        async function loadEarnings() {
            ...
            try {
                ...
                const vendorOrders = allOrders
                    .filter(o => o.sellerId && mySellerIds.includes(o.sellerId) && o.paymentStatus === 'Paid')
                    .map(o => ({...o, commission: parseFloat(o.price) * 0.02})); // Assume 2% commission for vendor
    ...
    <AppShell title="My Earnings">
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Summary of your revenue from products sold by your sellers.
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                     <div className="p-4 bg-blue-50 rounded-lg">
                        <dt className="text-sm font-medium text-blue-700 flex items-center justify-center gap-1"><DollarSign className="h-4 w-4"/>Total Revenue (from your products)</dt>
                        <dd className="text-2xl font-bold text-blue-800">₹{totalRevenue.toFixed(2)}</dd>
                    </div>
                     <div className="p-4 bg-red-50 rounded-lg">
                        <dt className="text-sm font-medium text-red-700 flex items-center justify-center gap-1"><TrendingDown className="h-4 w-4"/>Your Commission</dt>
