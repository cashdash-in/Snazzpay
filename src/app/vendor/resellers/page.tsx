...
export default function VendorCollaboratorsPage() {
    ...
    const storageKey = user ? `collaborators_vendor_${user.uid}` : '';
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                    <div>
                        ...
                        <CardDescription>Manage your team of guest collaborators who promote products on your behalf.</CardDescription>
                    </div>
                    <Dialog>
