        ...
        const mailOptions = {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; line-height: 1.6;">
                    ...
                    <p>We noticed you started the confirmation process for your order but didn't complete it. To finalize your Cash on Delivery (COD) order, please complete the secure authorization process by clicking the link below.</p>
                    <p><strong>This is not a payment.</strong> It is a temporary hold on your card that is automatically released once you pay cash on delivery.</p>
                    <p><strong>Order Details:</strong></p>
                    <ul>
                        <li><strong>Product:</strong> ${productName}</li>
                        <li><strong>Amount:</strong> ₹${amount}</li>
                    </ul>
                    <a href="${secureUrl}" style="background-color: #663399; color: white; padding: 12px 20px; text-decoration: none; border-radius: 5px; display: inline-block; margin: 20px 0;">Complete My Order</a>
