        ...
        const mailOptions = {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; line-height: 1.6;">
                    ...
                    <p>Thank you for your order. To confirm your Cash on Delivery (COD) order and ensure faster processing, please complete the secure authorization process by clicking the link below.</p>
                    ...
                    <a href="${secureUrl}" style="background-color: #663399; color: white; padding: 12px 20px; text-decoration: none; border-radius: 5px; display: inline-block; margin: 20px 0;">Secure My Order Now</a>
