...
export default function CollaboratorOrdersPage() {
  ...
  const fetchLeads = useCallback(async () => {
    ...
    try {
      ...
      // Only show leads that were generated by this collaborator and haven't been pushed yet
  ...
  const handlePushToSeller = async (lead: EditableOrder) => {
    ...
    try {
      ...
      toast({ variant: 'destructive', title: "Failed to push order", description: e.message });
    } finally {
