        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-50 p-4">
            <Card className="w-full max-w-4xl shadow-lg">
                ...
                <CardContent className="space-y-6 text-sm text-muted-foreground prose prose-sm max-w-none">
                    ...
                    <p>You acknowledge that customers who purchase your products via the Platform will be automatically enrolled in the Shakti COD Card loyalty program. This program is wholly managed, funded, and operated by Snazzify and its Partner Pay agents. Your responsibility is limited to the fulfillment of the product ordered. You are not liable for the issuance, management, or redemption of loyalty points or benefits associated with the Shakti Card. Benefits, such as discounts, are applied at the point of sale by our Partner Pay agents and do not affect the payout amount you receive for the product. Snazzify indemnifies you from any customer claims related to the Shakti Card loyalty program.</p>

                    <h3>4. Payment & Payouts</h3>
                    <p>Funds from a successfully authorized Secure COD order will be captured and transferred to your designated account only after the order has been marked as "Dispatched" in the Snazzify system and tracking information has been successfully assigned by a logistics partner. Payouts will be subject to a pre-agreed transaction fee (the "Platform Fee").</p>
