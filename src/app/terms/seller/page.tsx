        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-50 p-4">
            <Card className="w-full max-w-4xl shadow-lg">
                ...
                <CardContent className="space-y-6 text-sm text-muted-foreground prose prose-sm max-w-none">
                    ...
                    <p>You acknowledge that customers who purchase your products via the Platform will be enrolled in the Shakti COD Card loyalty program. This program is wholly managed, funded, and operated by Snazzify. Your responsibility is limited to the fulfillment of the product ordered. You are not liable for the issuance, management, or redemption of loyalty points or benefits associated with the Shakti Card. Benefits are applied at the point of sale by Partner Pay agents and do not affect your payout amount.</p>
